...
public class CityController {
	 ...
	 */
	@RequestMapping("/city")
	public City getByName(@RequestParam(required = false) String cityName, 
			@RequestParam(required = false)  String localCityName){
		return cityService.getByName(cityName, localCityName);
	}
	...
	public PageInfo<City> getCitiesByPage(@RequestParam(required = false) int currentPage, 
			@RequestParam(required = false) int pageSize, @RequestParam(required = false) int countryId) {
